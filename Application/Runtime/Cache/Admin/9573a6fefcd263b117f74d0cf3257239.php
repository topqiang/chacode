...
<script type="text/javascript" src="/chacode/Public/Admin/js/ajax_submit.js"></script>
</head>
<body id="login">
    <div id="login-wrapper" class="png_bg">
        <div id="login-top">
            <a href="#"><img id="logo" src="/chacode/Public/Admin/images/logo.png" alt="logo" style="width:200px;" /></a>
        </div>
