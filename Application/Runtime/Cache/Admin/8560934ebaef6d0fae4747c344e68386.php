    ...
    <div class="content-box">
        ...
        <div class="content-box-header">
            ...
            <ul class="content-box-tabs">
                <li><a href="#tab1" class="default-tab">回复内容</a></li>
            </ul>
            <div class="clear"></div>
        </div>
        <!--表格内容-->
        <div class="content-box-content">
            ...
            <div class="tab-content default-tab" id="tab1">
                <form action="<?php echo U('WeiXinArticle/editNoneAnswerBack');?>" method="post" class="form">
                    <fieldset>
                        <p>
                            <span style="color: red;font-size: 15px;font-weight: bold">触发时机：　　未查到匹配关键词的回答的时候将会触发此回复。</span>
                        </p>
                        <p>
                            <span class="label">回复文字内容：　</span>
                            <textarea class="text-input textarea" name="wxa_description"><?php echo ($none_answer_back['wxa_description']); ?></textarea>
                        </p>
                        <p>
                            <span class="label">回复图文关键词：</span>
                            <input class="text-input medium-input datepicker" type="text" name="wxa_keywords" value="<?php echo ($none_answer_back['wxa_keywords']); ?>"/><br>
                            　　　　　　　　　<span style="color:#EC5B4D">注：只能填写一个关键词，此项如果填写，文字回复将会失效。此项为完全匹配</span>
                        </p>
                        <p>
                            <input class="button edit-btn" type="submit" value="保　存" />
                        </p>
                    </fieldset>
                    <div class="clear"></div>
                </form>
